...
declare module '@micro-fleet/service-communication/dist/test/DirectRpcCaller.spec' {
	import 'reflect-metadata';

}
declare module '@micro-fleet/service-communication/dist/test/DirectRpcHandler.spec' {
	import 'reflect-metadata';

}
declare module '@micro-fleet/service-communication/dist/test/DirectRpcHandlerAddOnBase.spec' {
	export {};

}
declare module '@micro-fleet/service-communication/dist/test/rabbit-options' {
	import { IConnectionOptions } from '@micro-fleet/service-communication/dist/app'; const _default: {
...
declare module '@micro-fleet/service-communication/dist/test/MediateRpcCaller.spec' {
	import 'reflect-metadata';

}
declare module '@micro-fleet/service-communication/dist/test/MediateRpcHandler.spec' {
	import 'reflect-metadata';

}
declare module '@micro-fleet/service-communication/dist/test/MediateRpcHandler.stress' {
	import 'reflect-metadata';

}
declare module '@micro-fleet/service-communication/dist/test/MediateRpcHandlerAddOnBase.spec' {
	export {};

}
declare module '@micro-fleet/service-communication/dist/test/MessageBrokerAddOn.spec' {
	export {};
